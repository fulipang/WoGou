...
@implementation MyOrderRoomReservationViewController
{
...
- (void)loadCostomViw
{
    ...
    [self setNavigationBarTitle:@"我的订房订单"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setCellTypeWithOrderType:kOrderTypeReservation];
...
//        self.hidesBottomBarWhenPushed = YES;
//        OrderPaymentViewController * VC = [[OrderPaymentViewController alloc] initPrepayID:model.prepayid orderNumber:model.ordernum];
//        [self.navigationController pushViewController:VC animated:YES];
