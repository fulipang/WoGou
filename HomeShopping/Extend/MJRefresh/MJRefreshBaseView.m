...
//    arrowImage.image = [UIImage imageNamed:(@"hand")];
//    [self addSubview:_arrowImage = arrowImage];
    ...
    handImage.contentMode = UIViewContentModeScaleAspectFit;
    handImage.image = [UIImage imageNamed:@"hand"];
    [self addSubview:_handImage = handImage];
    // 6.设置默认状态
...
- (void)setFrame:(CGRect)frame
{
    ...
    _lastUpdateTimeLabel.frame = CGRectMake(statusX, statusY, statusWidth, statusHeight);
    ...
    _statusLabel.frame = CGRectMake(statusX, lastUpdateY, statusWidth, statusHeight);
...
//    _arrowImage.frame = CGRectMake(arrowX, statusY, 30.0f, 30.0f);
    ...
    // 手
    _handImage.frame = CGRectMake(SCREEN_WIDTH / 2 - 9, kViewHeight - 30, 18, 22);
    // 4.指示器
    _activityView.frame = _handImage.frame;
    _activityView.center = _handImage.center;
    _activityView.color = UIColorFromRGB(GRAYBGCOLOR);
...
//			_arrowImage.hidden = YES;
            ...
            _handImage.transform = CGAffineTransformIdentity;
