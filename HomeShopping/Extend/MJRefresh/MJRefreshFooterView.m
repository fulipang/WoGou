...
- (void)adjustFrame
{
    ...
    center.y = _handImage.center.y - 25;
...
//            }];
            ...
            [UIView animateWithDuration: 0.2 delay: 0 options: UIViewAnimationCurveEaseIn | UIViewAnimationOptionAllowUserInteraction animations:^{
                _handImage.transform = CGAffineTransformScale(_handImage.transform, 1.5, 1.5);
                UIEdgeInsets inset = _scrollView.contentInset;
                inset.top = 0;
                _scrollView.contentInset = inset;
